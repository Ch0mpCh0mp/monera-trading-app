...
export default function WatchlistHeader<T extends string>({
  tabs,
  activeTab,
  onTabChange,
  onAddClick,
  onEditClick,
}: WatchlistHeaderProps<T>) {
  const iconBtnBase =
        ...
        <div className="flex items-center gap-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`shrink-0 px-3 py-1.5 rounded-lg text-sm text-center transition ${
                activeTab === tab
